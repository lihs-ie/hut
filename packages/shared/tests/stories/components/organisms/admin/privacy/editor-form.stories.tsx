...
import { PolicyEditorForm } from "@shared/components/organisms/admin/privacy";
import { EditablePolicySection } from "@shared/components/molecules/editor/policy-section";

const meta = {
  component: PolicyEditorForm,
  parameters: {
    layout: "fullscreen",
  },
} satisfies Meta<typeof PolicyEditorForm>;

export default meta;

type Story = StoryObj<typeof PolicyEditorForm>;

const emptySections: EditablePolicySection[] = [
  {
    headline: "",
    body: "",
    list: null,
...
export const SingleSection: Story = {
  args: {
    initialSections: [sampleSections[0]],
    onSave: mockOnSave,
    title: "プライバシーポリシー編集",
  },
};
