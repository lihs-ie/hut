...
|---|---|---|---|---|
| reader | STG | Cloud Run | `hut-stg-reader` | `hut-stg-reader-<hash>.a.run.app` |
| reader | PRD | Cloudflare Workers | `hut-reader` | `hut-reader.<account>.workers.dev` |
| admin | STG | Cloud Run | `hut-stg-admin` | `hut-stg-admin-<hash>.a.run.app` |
| admin | PRD | Cloud Run | `hut-prd-admin` | `hut-prd-admin-<hash>.a.run.app` |
