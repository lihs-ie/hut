...
readonly ARTICLE_DIR
readonly PROJECT_FILE="cabal-wasm.project"
readonly BUILD_DIR="${WASM_BUILD_DIR:-${ARTICLE_DIR}/dist-newstyle-wasm}"
...
build_worker() {
  ...
  mkdir -p "${runtime_directory}/generated"
...
build_worker article-do-worker "${ARTICLE_DIR}/runtime/article-do-worker"
build_worker article-excerpt-worker "${ARTICLE_DIR}/runtime/article-excerpt-worker"
build_worker article-completion-worker "${ARTICLE_DIR}/runtime/article-completion-worker"
