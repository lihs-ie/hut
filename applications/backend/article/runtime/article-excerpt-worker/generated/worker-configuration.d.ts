/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=runtime/article-excerpt-worker/wrangler.jsonc --env=dev runtime/article-excerpt-worker/generated/worker-configuration.d.ts` (hash: fdebafc64c1adb1d8027ab1001735b1d)
// Runtime types generated with workerd@1.20260916.1 2026-09-13 nodejs_compat
interface __BaseEnv_Env {
	ARTICLE_EXCERPT_COMPLETION_QUEUE: Queue;
	AI: Ai;
	ARTICLE_DO: DurableObjectNamespace /* ArticleDurableObject from hut-article-api-worker-dev */;
}
