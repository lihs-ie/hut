/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=runtime/article-do-worker/wrangler.jsonc --env=dev runtime/article-do-worker/generated/worker-configuration.d.ts` (hash: 7fc04a2d211263c985bb0471bdc177f4)
// Runtime types generated with workerd@1.20260916.1 2026-09-13 nodejs_compat
interface __BaseEnv_Env {
	ARTICLE_EXCERPT_GENERATION_QUEUE: Queue;
	ARTICLE_DO: DurableObjectNamespace<import("../src/index").ArticleDurableObject>;
	MEDIA_API: Fetcher /* hut-media-api-worker-dev */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("../src/index");
		durableNamespaces: "ArticleDurableObject";
	}
