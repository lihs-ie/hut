/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=runtime/media-api-worker/wrangler.jsonc --env=stg --env-interface=MediaApiWorkerEnv runtime/media-api-worker/generated/worker-configuration.d.ts` (hash: 0343e2aabaaec80794fe9d04835438e8)
// Runtime types generated with workerd@1.20260915.1 2026-09-13 nodejs_compat
interface __BaseEnv_MediaApiWorkerEnv {
	MEDIA_DATABASE: D1Database;
	MEDIA_INSPECTION_QUEUE: Queue;
...
declare namespace Cloudflare {
	...
	interface Env extends __BaseEnv_MediaApiWorkerEnv {}
}
interface MediaApiWorkerEnv extends __BaseEnv_MediaApiWorkerEnv {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MEDIA_TMP_UPLOADS_BUCKET_NAME">> {}
}
