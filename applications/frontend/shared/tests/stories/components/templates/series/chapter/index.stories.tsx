...
} satisfies Meta<typeof ChapterIndex>;
...
export const Default: StoryObj<typeof ChapterIndex> = {
  args: {
    slug,
    chapterSlug,
    series,
...
export const MiddleChapter: StoryObj<typeof ChapterIndex> = {
  args: {
    slug,
...
export const LastChapter: StoryObj<typeof ChapterIndex> = {
  args: {
    slug,
