...
import { SeriesDetailPresenter } from "@shared/components/organisms/series/detail/index.presenter";
...
const meta = {
  component: SeriesDetailPresenter,
} satisfies Meta<typeof SeriesDetailPresenter>;
...
export const Default: StoryObj<typeof SeriesDetailPresenter> = {
  args: {
    series,
    slug,
    chapters,
...
export const WithCover: StoryObj<typeof SeriesDetailPresenter> = {
  args: {
    ...
    tags: tagForger.forgeMultiWithSeed(1, 1),
  },
};

export const FewChapters: StoryObj<typeof SeriesDetailPresenter> = {
  args: {
    series: seriesForger.forge({
      title: "短いシリーズ",
